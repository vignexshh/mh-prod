...
with open("/Users/namanmuktha/Desktop/mediksearch/Tel & Ap Data/46. College_Wise_P7.txt", "r") as file:
    data_all = file.read()
...
columns = ['COLLEGE', 'RANK', 'LOC', 'CAT', 'SX','EWS','PHASE']
...
for line in lines_all:
    if line.startswith("COLL ::"):
        ...
        parsed_data.append([college, rank, loc, cat, sx, ews, phase])

# Create DataFrame
df_all = pd.DataFrame(parsed_data, columns=columns)

# Write the DataFrame to a CSV file
df_all.to_csv("t2.csv", index=False)
